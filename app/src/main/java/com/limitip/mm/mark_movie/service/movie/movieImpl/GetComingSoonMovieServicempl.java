...
public class GetComingSoonMovieServicempl implements MovieService {
    private List<Movie> movies = new ArrayList<Movie>();
    private DoubanMovie doubanMovie;
    private Activity activity;
    private OneFragment oneFragment;

    public GetComingSoonMovieServicempl(OneFragment oneFragment) {
    ...
    public void getMovice() {
        String url = "/v2/movie/coming_soon?"
                +"id="+ Id.id
                +"&&token="+ Id.token;
